...
with open("output_text/corrected-Devanagari-from-txt.json", "r", encoding="utf-8") as f:
        ...
        for j, data_final_section_Devanagari in enumerate(supersections_Devanagari[supersection_Devanagari].get('sections', [])):
            if data_final_section_Devanagari == data_corrected_section_Devanagari:
                ...
                for k,data_corrected_subsection_Devanagari in enumerate(data_corrected_subsections_Devanagari):
                    #print(f" k is {k} {data_corrected_subsection_Devanagari}")
                    #print(f" data_final_subsections_Devanagari is {data_final_subsections_Devanagari}")
                    ...
                    data_final_subsections_Devanagari[data_corrected_subsection_Devanagari]['header']['header'] = data_corrected_subsections_Devanagari[data_corrected_subsection_Devanagari]['header']['header']
